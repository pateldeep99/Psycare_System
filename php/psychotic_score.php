	...
	<!-- End header -->
				...
				<div class="card text-center border-0"> 
					<div class="card-body">
						...
						<p id="id2">Congratulations You have completed psychotic test succesfully.</p>
						<h1 id="id7"><?php echo $_SESSION['score']; ?></h1>
						<p id="id3">Your <strong>Score</strong>
						<br>
							<?php if($_SESSION['score'] <= 35) : ?>
								<h3 id="id4">You have low level psychotic disorder</h3>

							<?php  elseif($_SESSION['score'] > 35 &&$_SESSION['score'] <= 65) :	?>
							<h3 id="id5">You have medium level psychotic disorder</h3>
						
							<?php else:	?>
							<h3 id="id6">You have High level psychotic disorder</h3>
							<?php endif; ?>
						</p>
