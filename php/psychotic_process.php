...
<?php 
 ...
 if($_GET){
	//We need total question in process file too
 	$query = "SELECT * FROM psychotic_question";
	...
	if ($number === 1) {
 	 ...
 	 if($number == $total_questions)
 	 {
		...
		$str="INSERT into history(name,type,score) VALUES('".$_SESSION['name']."','psychotic' ,'".$_SESSION['score']." %')";
		$connection->query($str);	
 	  	 	header("LOCATION: psychotic_score.php");
 	 }
 	 else{
 	 	header("LOCATION: psychotic_quiz.php?n=". $next);
 	 }
 }
?>