 ...
 if($_GET){
	...
	if ($number === 1) {
 	 ...
 	 if($number == $total_questions)
 	 {
		...
		$str="INSERT into history(name,type,score) VALUES('".$_SESSION['name']."','anxiety' ,'".$_SESSION['score']." %')";
		$connection->query($str);	
 	  	header("LOCATION: anxiety_score.php");
 	 }
 	 else{
 	 	header("LOCATION: anxiety_quiz.php?n=". $next);
 	 }
 }
?>