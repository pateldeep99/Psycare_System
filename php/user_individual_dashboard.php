...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <!-- End header -->
        <div class="sidebar">
            ...
            <a class="active" href="user_individual_dashboard.php">Individual Test history</a>
            <a href="user_consultancy_dashboard.php">Consultancy</a>
        </div>
        <div class="content">
                        <?php
                        $result = mysqli_query($connection,"SELECT * FROM history WHERE type !='common' && name='".$_SESSION['name']."'")  or die('Error');
