...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item active" href="../php/Echeckup.php">Individual Quiz</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
	...
	<!-- End header -->
			...
			<div class="card text-center border-0">
				...
				<div class="card-body">
					<h2 class="head">Depression disroder test</h2>
					<div class="Checkup">
					...
					<a href="../PHP/depression_quiz.php"><button class="button">Take a test</button></a>			
				</div>	

				<!-- this code is for bipolar checkup -->
				<div class="card-body">
					<h2 class="head">Bipolar disroder test</h2>
					<div class="Checkup">
						<!-- image for better understanding -->
					...
					<a href="../PHP/bipolar_quiz.php"><button class="button">Take a test</button></a>	
				</div>
		
				<!-- this code is for Anxiety checkup -->
				<div class="card-body">
					<h2 class="head">Anxiety disroder test</h2>
					<div class="Checkup">
						<!-- image for better understanding -->
					...
					<a href="../PHP/anxiety_quiz.php"><button class="button">Take a test</button></a>			
				</div>		

				<!-- this code is for Personality checkup -->
				<div class="card-body">
					<h2 class="head">Personality disroder test</h2>
					<div class="Checkup">
						<!-- image for better understanding -->
					...
					<a href="../PHP/personality_quiz.php"><button class="button">Take a test</button></a>			
				</div>		

				<!-- this code is for Eating checkup -->
				<div class="card-body">
					<h2 class="head">Eating disorder test</h2>
					<div class="Checkup">
						<!-- image for better understanding -->
					...
					<a href="../PHP/eating_quiz.php"><button class="button">Take a test</button></a>			
				</div>	
				
				<!-- this code is for Psychotic checkup -->
				<div class="card-body">
					<h2 class="head">Psychotic disorder test</h2>
					<div class="Checkup">
						<!-- image for better understanding -->
					...
					<a href="../PHP/psychotic_quiz.php"><button class="button">Take a test</button></a>			
				</div>	
				
				<!-- this code is for Post-traumatic checkup -->
				<div class="card-body">
					<h2 class="head">Post-traumatic disorder test</h2>
					<div class="Checkup">
						<!-- image for better understanding -->
					...
					<a href="../PHP/post-traumatic_quiz.php"><button class="button">Take a test</button></a>			
				</div>	
			</div>
