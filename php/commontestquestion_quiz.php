<?php 
	...
	// $_SESSION['name'] = "SELECT name FROM user WHERE ";
	//Set Question Number
	$number = isset($_GET['n']) ? $_GET['n'] : 1;
	
	//Query for the Question
	$query = "SELECT * FROM commontest_question WHERE question_number = ".$number;
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
	...
	<!-- End header -->
				...
				<div class="card text-center border-0">
					<form action="commontestquestion_process.php" method="GET">
					<div class="card-body">
