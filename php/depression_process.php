 ...
 if($_GET){
	...
	if ($number === 1) {
 	 ...
 	 if($number == $total_questions)
 	 {
		...
		$str="INSERT into history(name,type,score) VALUES('".$_SESSION['name']."','depression' ,'".$_SESSION['score']." %')";
		$connection->query($str);	
 	  	 	header("LOCATION: depression_score.php");
 	 }
 	 else{
 	 	header("LOCATION: depression_quiz.php?n=". $next);
 	 }
 }
?>